/**
 * Wire contracts for every server function that takes input. They live in `lib/`
 * because both sides use them: server handlers as `.validator(...)`, and forms
 * to check a submission before it leaves the browser. Nothing here may import
 * `cloudflare:workers`.
 *
 ...
 */
import { z } from "zod";
import { ANNOTATION_MODES, ENTRY_KINDS, SECTION_TYPES } from "./constants";
